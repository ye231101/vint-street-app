...
export const selectBasketProtectionFee = createSelector(
  [selectBasket],
  (basket) => basket.totalProtectionFee
);

export const selectBasketFormattedTotal = createSelector(
  [selectBasket],
  (basket) => basket.formattedTotal
);

export const selectBasketFormattedSubtotal = createSelector(
  [selectBasket],
  (basket) => basket.formattedSubtotal
);
