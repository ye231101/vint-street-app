...
export default function SellScreen() {
  ...
  const categories = [
    "Men's", "Women's", "Junior's", "Footwear", 
    "Games", "Consoles", "Music", "Trading Cards", 
    "Collectibles", "Uncategorised"
  ];
  ...
  const checkForUnsavedChanges = () => {
    const hasChanges = Boolean(title || description || price || brand || category || 
                     purchaseNote || selectedImages.length > 0 || stockManagement);
